...
<table class="table table-bordered">
     ...
     <tr><td>Prodi</td>
          <td>
               <div class="col-sm-6">
                  ...
                  <?php echo buatcombo('prodi', 'akademik_prodi', 'col-sm-3', 'nama_prodi', 'prodi_id', '', array('id'=>'prodi'))?>
    ...
    <td width="150">Tempat ,Tanggal Lahir</td><td>
        ...
        <?php echo inputan('date', 'tanggal_lahir','col-sm-3','Tanggal Lahir ..', 0, '',array('id'=>'datepicker'));?>
    </td>
    </tr>
