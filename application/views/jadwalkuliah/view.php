...
<div class="col-sm-2">
    ...
    <tr style="display: none;"><td>Program Studi <?php echo buatcombo('prodi', 'akademik_prodi', '', 'nama_prodi', 'prodi_id', $param, array('id'=>'prodi'))?></td></tr>
    <!-- <tr style="display: none;"><td>Konsentrasi <?php echo combodumy('konsentrasi', 'konsentrasi')?></td></tr> -->
    ...
    <tr><td><?php echo anchor('#example-modal','Autosetup',array('class'=>'btn btn-primary  btn-sm','data-toggle'=>'modal'));?> 
            <button type="submit" class="btn btn-primary  btn-sm"><span class="glyphicon glyphicon-print"><tr></span> Cetak Data

            <td><?php echo anchor('jadwalkuliah/post','Input Data',array('class'=>'btn btn-primary  btn-sm'));?></td>
</button>
