...
<div class="col-md-3">
    <table class="table table-bordered">
        ...
        <tr><td width="120"><?php echo inputan('date', 'tanggal', 'col-md-14', 'Tanggal', 1, $this->session->userdata('sess_login_absen'), array('id'=>'datepicker'))?>
                ...
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                                                     <table class="table table-bordered">
                            <tr><td>Tanggal</td><td><?php echo inputan('date', 'tanggal2', 'col-md-6', 'Tanggal', 1,'', array('id'=>'datepicker2'))?></td><tr>
