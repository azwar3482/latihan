...
class cetak extends CI_Controller
{
    ...
    function cetakkhs()
    {
        ...
        $sqlMHS     =   "SELECT ap.nama_prodi,ak.nama_konsentrasi,sm.nama,sm.nim,sm.semester_aktif,sm.ipk
       ...
       $pdf->Cell(130, 5, 'SEKOLAH TINGGI ILMU EKONOMI GRAHA KARYA', 0, 1, 'C');
       $pdf->SetFont('TIMES','',10);
       $pdf->Cell(130, 5, 'Jalan Suryahadi 40513 ,Jambi', 0, 1, 'C');
       $pdf->Cell(130, 5, 'Telp.(022) 6645951 ,Fax(022)6645951', 0, 1, 'C');
       $pdf->Cell(130, 5, 'E-mail : http://www.kampus.ac.id', 0, 1, 'C');
       ...
       $pdf->Cell(35, 5, 'IP : '.number_format($ip,2) ,0, 1);
       $pdf->Cell(35, 5, 'IPK : '.number_format($m['ipk'],2) ,0, 1);
       ...
       $pdf->Cell(25, 10, '', 0, 1);
       $pdf->Cell(95, 5, '', 0, 0);
       $pdf->Cell(25, 5, 'Joko,S.Pd.M.T,', 0, 0);
       $pdf->Output();
    }
    ...
    function kum()
    {
        ...
        $pdf->Cell(100,2,'SEKOLAH TINGGI ILMU EKONOMI GRAHA KARYA',0,1);
        
        $pdf->SetFont('TIMES','',10);
        $pdf->Cell(100, 6, 'Jalan Suryahadi 40513 ,Jambi', 0, 1, 'L');
         $pdf->Cell(100, 3, 'E-mail : admin@yahoo.com ; Website : http://www.kampus.ac.id', 0, 1, 'L');
       ...
       $pdf->Cell(300,3,'                 atau pengawas ujian,jika KUM tidak dibawa harus minta surat keterangan dari akademik.',0,1);
        $pdf->SetFont('times','',10);
       $pdf->Text(155, 110, 'Jambi , '.  tgl_indo(waktu()));
       $pdf->Text(155, 115, 'Pembantu Direktur I');
       
       $pdf->Text(155, 130, 'Joko,S.Pd.M.T');
       $pdf->Output();
    }
